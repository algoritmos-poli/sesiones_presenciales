...
<div align="center">
  <img src="clasesUML.png" alt="Diagrama de una lista enlazada simple">
</div>

## Codigos

### Clase [`Node`](Node.java)
...
### Clase [`LinkedIntList`](LinkedIntList.java)
...
### Clase [`Test1LL`](Test1LL.java)
)

```java
public class Test1LL {
